...
function TermsPage() {
  return (
    <PageShell eyebrow="TERMS & CONDITIONS" title="Terms and Conditions">
      ...
      <P>We strive to ensure all product descriptions, pricing, and images are accurate. However, errors may occasionally occur.</P>
      ...
      <H2>Orders</H2>
      <P>We reserve the right to refuse or cancel any order where necessary, including suspected fraud, pricing errors, or stock availability issues.</P>
      <H2>Limitation of Liability</H2>
      <P>Roamforge shall not be liable for any indirect, incidental, or consequential damages arising from the use of products purchased from our store.</P>
      <H2>Governing Law</H2>
